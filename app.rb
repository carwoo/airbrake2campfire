...
post "/" do
  ...
  respond_body = "#{hoptoad_data["error"]["error_message"]}<br />#{hoptoad_data["error"]["error_class"]}<br /><a href='http://airbrake.io/projects/#{hoptoad_data["error"]["id"]}/errors'>View on Airbake...</a>"
